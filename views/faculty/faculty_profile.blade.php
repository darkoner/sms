...
@section('content')
    ...
    <script src="{{ URL::asset('js/angular/faculty/faculty_profile_controller.js') }}?v=<?php echo time() ?>"
            type="text/javascript"></script>

    <div id="profile" class="page-layout simple tabbed" ng-app="SMSApp" ng-controller="facultyProfileController">

        <div class="bg-white text-auto p-5 row no-gutters align-items-center justify-content-between">
            <div class="col-md-6">
                <h1 class="doc-title h4" id="content">
                    <span class="text-blue">My Profile - <%profile.name%></span>
                </h1>
            </div>
        </div>
                                ...
                                <div class="content p-4">
                                    <div class="row">
                                        ...
                                        <button type="button" class="btn  btn-info ml-4" ng-click="Save()"
                                                ng-if="auth_user.is_admin == 1">Update
                                        </button>
                                    </div>
                                </div>
                            </div>
